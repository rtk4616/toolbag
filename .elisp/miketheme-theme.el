;;; miketheme-theme.el --- Github color theme for GNU Emacs 24
...
;; ===========================================
;; MAKE SURE YOU HAVE 256 TERMINAL COLORS!
;;
;; You can do this in your .profile or .bashrc
;; export TERM=xterm-256color
;; ===========================================



(deftheme miketheme "Port of Github Theme for Emacs 24")
...
(let ((*background-color*  "white")
  ...
  (custom-theme-set-faces
   ...
   `(font-lock-type-face ((t (:foreground "#445588" :weight bold))))
   ...
   `(quack-pltish-class-defn-face ((t (:bold t :foreground "purple3"))))
