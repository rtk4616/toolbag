...
;;
;; ========================================
;; Modified: Oct 8, 2012, by Mike Wilkerson
;; ========================================
...
(defun color-theme-molokai ()
  ...
  (color-theme-install
   '(color-theme-molokai
     ...
     ;; The below line was the original bg/fg line. Commented it out in order to
     ;; set the background color via OSX's terminal preferences.
     ...
     (markdown-comment-face ((t (:foreground "#0000ff"))))
