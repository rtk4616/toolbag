...
vnoremap L gt
nnoremap L gt
vnoremap <silent> \ :call EasyMotion#F(1, 0)
onoremap <silent> \ :call EasyMotion#F(0, 0)
nnoremap <silent> \ :call EasyMotion#F(0, 0)
let s:cpo_save=&cpo
set cpo&vim
nmap gx <Plug>NetrwBrowseX
nnoremap <silent> <Plug>NetrwBrowseX :call netrw#NetrwBrowseX(expand("<cWORD>"),0)
nnoremap <F6> :set invpaste paste?
nnoremap <F5> :set nonumber!
let &cpo=s:cpo_save
unlet s:cpo_save
set autoindent
set backspace=2
...
silent only
cd ~/development/python/tango-nba_nets/nba_nets
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +71 ~/.vimrc
args ~/development/python/tango-nba_nets/nba_nets
...
argglobal
enew
file ~/development/python/tango-nba_nets/nba_nets
let s:cpo_save=&cpo
set cpo&vim
...
lcd ~/development/python/tango-nba_nets/nba_nets
tabedit ~/.vimrc
set splitbelow splitright
set nosplitbelow
set nosplitright
